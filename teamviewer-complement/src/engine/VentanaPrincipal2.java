...
public class VentanaPrincipal2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					//int so = SO.getSoSystem();
					int so = 2;
					if(so!=2) {
						JOptionPane.showMessageDialog(null, "Todavía no está desarrollada la herramienta para este Sistema operativo", "Sistema Operativo incompatible", JOptionPane.ERROR_MESSAGE);
					}else{						
	...
	public VentanaPrincipal2() {
		...
		mntmAcercaDe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Proyecto desarrollado por Victor Carreras @2017", "Acerca de", JOptionPane.INFORMATION_MESSAGE);
			}
		});
		...
		btnActivar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(proceso.getEstado()) {
					...
					JOptionPane.showMessageDialog(null, " Activado con éxito!");
					cambiarEstado();
				}else {
					JOptionPane.showMessageDialog(null, "Ups, no se ha podido activar el servicio. Por favor, ponte en contacto con tu administrador del sistema", "Error al activar el servicio", JOptionPane.INFORMATION_MESSAGE);
				}
			}
		});
		...
		btnDesactivar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(proceso.desactivarServicio()) {
					...
					JOptionPane.showMessageDialog(null, " Desactivado con éxito!");
					cambiarEstado();
				}else {
					JOptionPane.showMessageDialog(null, "Ups, no se ha podido desactivar el servicio. Por favor, ponte en contacto con tu administrador del sistema", "Error al desactivar el servicio", JOptionPane.INFORMATION_MESSAGE);
				}
